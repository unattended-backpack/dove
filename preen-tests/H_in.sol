...
/// @notice The Optimism token used in governance and supporting voting and
/// delegation. Implements
///         EIP 2612 allowing signed approvals. Contract is "owned" by a
/// `MintManager` instance with
///         permission to the `mint` function only, for the purposes of
/// enforcing the token
///         inflation schedule.
