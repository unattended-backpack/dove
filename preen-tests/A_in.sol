...
contract StorageSetter is ISemver {
    ...
    function setBytes32(bytes32 slot, bytes32 value) public {
        Storage.setBytes32(slot, value); // This is an example of a postfix comment that ought to be moved.
    }
  ...
  function resourceConfig() internal view
