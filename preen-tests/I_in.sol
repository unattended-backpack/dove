...
/// @title MintManager
/// @notice Set as `owner` of the governance token and responsible for the token
/// inflation
///         schedule. Contract acts as the token "mint manager" with permission
/// to the `mint`
///         function only. Currently permitted to mint once per year of up to 2%
/// of the total
...
contract MintManager is Ownable {
  ...
  /// @notice The amount of time that must pass before the MINT_CAP number of
  /// tokens can
  ///         be minted again.
